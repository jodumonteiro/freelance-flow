...
export default function PricingSection() {
  const handleSubscribe = (plan: 'starter' | 'growth') => {
    if (plan === 'starter') {
      window.location.href = '[https://freelanceeflow.gumroad.com/l/gtcoao](https://freelanceeflow.gumroad.com/l/gtcoao)';
    } else {
      window.location.href = '[https://freelanceeflow.gumroad.com/l/rawoa](https://freelanceeflow.gumroad.com/l/rawoa)';
    }
  };
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
          ...
          <div style={{ backgroundColor: '#18181b', border: '1px solid #27272a', borderRadius: '16px', padding: '32px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <button
              ...
              style={{ marginTop: '32px', width: '100%', backgroundColor: '#27272a', color: '#fff', fontWeight: '500', padding: '12px 16px', borderRadius: '12px', border: '1px solid #3f3f46', cursor: 'pointer' }}
            >
